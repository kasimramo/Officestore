      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-4 flex md:ml-4 md:mt-0 gap-3">
            <div className="flex items-center gap-2 rounded-md border border-slate-300 px-3 py-1.5 text-sm bg-white">
              <Search className="w-4 h-4 text-slate-500" />
              <input
                placeholder="Search sites, areas"
                className="border-0 focus:ring-0 w-40 text-sm"
                value={searchTerm}
                      ...
                      <div className="bg-white">
                        {site.areas.length === 0 ? (
                          ...
                          <div className="divide-y divide-slate-100">
                            {site.areas.map((area) => (
                              <div key={area.id} className="px-6 py-4 hover:bg-slate-50">
                                <div className="flex items-center justify-between">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      ...
                                      {area.description && (
                                        <div className="text-sm text-slate-600 mt-1">{area.description}</div>
                                      )}
                                      <div className="text-xs text-slate-500 mt-1">
                                  ...
                                  <div className="flex items-center gap-1">
                                    ...
                                    >
                                      {area.isActive ? <PowerOff className="w-4 h-4" /> : <Power className="w-4 h-4" />}
                                    </button>
                                  </div>
                                </div>
                              </div>
