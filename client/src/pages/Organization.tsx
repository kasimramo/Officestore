    ...
    <div className="mx-auto container-max px-4 sm:px-6 lg:px-8 py-6">
      ...
      <div className="border-b border-slate-200 mb-8">
        <nav className="-mb-px flex space-x-8">
          <button className="border-blue-500 text-emerald-600 whitespace-nowrap py-2 px-1 border-b-2 font-medium text-sm">
            Overview
          </button>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select className="w-full px-3 py-2 border border-slate-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
